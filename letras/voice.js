            ...
            a.getVoices = function() {
                ...
                a.speak = function(b, c, f) {
                    if (a.iOS9&&!a.iOS9_initialized)
                        console.log("Initializing ios9"), setTimeout(function() {
                            a.speak(b, c, f)
                        ...
                        if (b.length > a.CHARACTER_LIMIT) {
                            for (var e = b; e.length > a.CHARACTER_LIMIT;) {
                                ...
                                if ( - 1 == g || g >= a.CHARACTER_LIMIT)
                                    ...
                                    - 1 == g&&-1 == e.search(" ") && (g = 99);
                                    if ( - 1 == g || g >= a.CHARACTER_LIMIT)
                                        for (var k = e.split(" "), g = 0; g < k.length&&!(d.length + k[g].length + 1 > a.CHARACTER_LIMIT); g++)
                                            d += (0 != g ? " " : "") + k[g];
                                    else
                                        d = e.substr(0, g + 1);
                                    ...
                                    0; g < h.length; g++)
                                        if (a.fallbackMode) {
                                            ...
                                            var d = a.selectBest([e.collectionvoice.pitch, e.systemvoice.pitch, 1]), k = a.selectBest([a.iOS9 ? 1: null, e.collectionvoice.rate, e.systemvoice.rate, 1]), l = a.selectBest([e.collectionvoice.volume, e.systemvoice.volume, 1]), m;
                ...
                a.startTimeout = function(b, c) {
                    ...
                    if (!(0 >= f)) {
                        var h = b.split(/\s+/).length, e = (b.match(/[^ ]/igm) || b).length, f = 60 / a.WORDS_PER_MINUTE * f * 1E3 * (e / h / 5.1) * h;
                        3 > h &&
                        (f = 4E3);
                        3E3 > f && (f = 3E3);
                        ...
                        function(b) {
                            if ("undefined" === typeof a.systemvoices || null === a.systemvoices)
                                ...
                                for (var c = 0; c < a.systemvoices.length; c++)
                                    if (0 == a.systemvoices[c].name.localeCompare(b))
...
var config = JSON.parse('{\"searchMessage\":false,\"welcomeMessage\":false,\"welcomeMessage2\":false,\"speakSelectedText\":true,\"speakLinks\":false,\"speakInactivity\":false,\"speakEndPage\":false,\"exitIntent\":false,\"accesibilityNavigation\":false,\"accesibilityNavigation2\":false,\"welcomeMessageTime\":false,\"text_welcomeMessage\":\"\",\"text_welcomeMessage2\":\"\",\"text_speakInactivity\":\"\",\"text_speakEndPage\":\"\",\"text_exitIntent\":\"\",\"trackEvents\":false,\"abTesting\":false,\"analytics_id\":null,\"analyticsSettings\":{\"date\":\"2016-08-21\",\"period\":\"month\"}}');
...
jQuery(window).load(function() {
    ...
    jQuery('a').hoverIntent(function() {
        ...
        if (config.speakLinks) {
            ...
            responsiveVoice.speak(jQuery(this).text(), 'Spanish Female');
    ...
    if (config.accesibilityNavigation) {
        $('a').keyup(function(e) {
            ...
            if (code == '9') {
                responsiveVoice.speak('Link 2 ' + $(':focus').text(), 'Spanish Female');
        ...
        $('button').keyup(function(e) {
            ...
            var code = e.keyCode || e.which;
            if (code == '9') {
                setTimeout(responsiveVoice.speak($(':focus').text() + ' button', 'Spanish Female'), 1000);
                trackEvent('agentFeature', 'accesibilityNavigation', 'tab');
            }
        });
        $('textarea').keyup(function(e) {
            ...
            if (code == '9') {
                ...
                responsiveVoice.speak('Text Input ' + $(':focus').attr('placeholder'), 'Spanish Female');
                trackEvent('agentFeature', 'accesibilityNavigation', 'tab');
            }
        });
    }
    if (config.accesibilityNavigation2) {
        $('body').keyup(function(e) {
            ...
            if (code == '40' && e.ctrlKey) {
                ...
                responsiveVoice.speak($('p').eq(started).text(), 'Spanish Female');
